...
#==============read file======
library(xlsx)
data=read.xlsx("C:/Users/SANJAI/Desktop/Matrix_file.xlsx", sheetIndex = 1, check.names=F) 
...
#============Score_Description========
library(xlsx)
data=read.xlsx('C:/Users/SANJAI/Desktop/Module_Exercise/ExcerciseFile/Score_Description.xlsx', sheetIndex = 1, check.names=F)
...
library(stringr)
library(dplyr)
data1=read.xlsx("C:/Users/SANJAI/Desktop/Module_Exercise/ExcerciseFile/Short_Name.xlsx", sheetIndex = 1, check.names=F)
...
#==================Extract DOB==============
library(stringr)
df1=read.xlsx("C:/Users/SANJAI/Desktop/Module_Exercise/ExcerciseFile/DOB.xlsx", sheetIndex = 1, check.names=F)
df1$DOB=str_extract(df1$`When is your date of birth?`, "[0-9/]{8,}")

#=======================Extract Name and Emp_id===================
library(stringr)
df2=read.xlsx("C:/Users/SANJAI/Desktop/Module_Exercise/ExcerciseFile/Extract_Emp_id_and_Name.xlsx",sheetIndex = 1, check.names=F)
